...
// Hook Defintion
const useGatherPeriodData = ({ selectedPeriod, timeFrame, workEntries }: UseGatherPeriodDataProps) => {
    const [timeFilteredWorkEntries, setTimeFilteredWorkEntries] = useState<WorkEntry[] | null>(null);

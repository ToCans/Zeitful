...
const handleMinutesChange = (value: string | number, setter: Dispatch<React.SetStateAction<any>>) => {
...
const SettingsTimeTile = ({ label, value, setter }: SettingsItemTileProps) => {
    ...
    return (<div className='flex flex-row xl:text-lg text-lg items-center justify-center w-full'>
        <div className='flex flex-row items-center gap-4'>
            ...
            />
            <InputText
                className={`w-12 h-10 text-center ${settings.darkMode ? 'dark-dropdown text-zinc-100' : 'light-dropdown text-black'}`}

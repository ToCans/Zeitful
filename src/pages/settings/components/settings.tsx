...
const Settings = () => {
	...
	return (
		<div
			className={`bg-white flex flex-col p-4 xl:w-2/5 md:w-3/5 w-11/12 h-[50vh] rounded-lg overflow-hidden shadow-[2px_2px_2px_rgba(0,0,0,0.3)] transform transition-transform duration-700 duration ease-out ${
		...
		>
			...
			<div className='flex flex-col items-center justify-center space-y-2 flex-1'>
				...
				<div className='flex flex-row space-x-2 sm:text-2xl items-center justify-center w-full'>
					...
					/>
					<p className='text-center align-middle select-none text-md w-3/5 lg:w-2/5 3xl:w-1/5'>
				...
				<div className='flex flex-row space-x-2 sm:text-2xl items-center justify-center w-3/5 lg:w-2/5 3xl:w-1/5'>
					<p className='text-center align-middle select-none text-md'>
						Show Timer in Tab
					</p>
					<label>
						<input

...
const Settings = () => {
	...
	return (
		<div
			className={`bg-white flex flex-col p-4 w-4/5 md:w-3/5 h-[50vh] md:h-2/5 rounded-lg overflow-hidden shadow-[2px_2px_2px_rgba(0,0,0,0.3)] transform transition-transform duration-700 duration ease-out ${isMounted ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0'
				}`}
		>
